...
class CourseView(object):
    ...
    def __init__(self, course):
         ...
         self.y = (int(course.course_number) % 10)*70 + 100  # coordinates of center
         self.course = course
         self.lightUp = False;

    def displayCirc(self,canvas):
        canvas.create_oval(self.x-25,self.y-25,self.x+25,self.y+25,fill="Blue")
